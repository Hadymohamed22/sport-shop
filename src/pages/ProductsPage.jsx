...
import img1 from "../assets/dumble-products-page.png";
import img2 from "../assets/goolkeeper-gloves.png";
import img3 from "../assets/soccor-shoe.png";
...
function ProductsPage() {
  ...
  return (
    <section className="products-page">
      <Hero
        mainText="Gear Up for Excellence in Every Sport!"
        subText="Discover the Best Selection of Sports Equipment and Apparel Designed for Performance and Comfort"
